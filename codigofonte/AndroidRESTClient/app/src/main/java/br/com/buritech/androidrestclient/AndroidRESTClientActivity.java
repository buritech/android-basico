package br.com.buritech.androidrestclient;
...
public class AndroidRESTClientActivity extends AppCompatActivity {
    ...
    private static final String SERVICE_URL = "http://192.168.0.59:8080/listakiweb/rest/usuario";
    ...
    public void postData(View vw) {
        ...
        wst.addNameValuePair("nome", firstName);
    ...
    public void handleResponse(String response) {
        ...
        try {
            ...
            String firstName = jso.getString("nome");
